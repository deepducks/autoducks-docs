...
Because these files are managed mirrors, editing them directly doesn't stick — the next update overwrites them, and `setup.sh` flags drift in the meantime. To extend or override how an agent runs without touching a mirror, see the [Customization guide](/guides/customization).
